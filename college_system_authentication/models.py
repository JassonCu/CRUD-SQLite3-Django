...
class Role(models.Model):
    ...
    """
    objects = RoleManager()
    name = models.CharField(_('Nombre'), max_length=50, unique=True, blank=False, null=False)
    name_spanish = models.CharField(
        _('Nombre Español'), max_length=50, default='', unique=True, blank=False, null=False)
    description = models.CharField(_('Descripción'), max_length=150, unique=True, blank=False, null=False)
